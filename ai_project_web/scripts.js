...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('cross-query-back').addEventListener('click', function() {
        ...
        // 移除內容動畫類
        crossQueryContent.classList.remove('animated');
...
// 注意：showMaterialDetail、showStainDetail和initCrossQuery函數已移至各自的文件中
// detail_functions.js包含物料和污漏詳情相關函數
// cross_query.js包含交叉查詢相關函數
    ...
    function sendMessage(message, isFromVoice = false) {
        ...
        callDeepSeekAPI(message)
            .then(response => {
                ...
                disclaimerElement.classList.add('ai-disclaimer');
                disclaimerElement.textContent = '以上內容由AI生成，信息僅供參考，請注意甄別';
                aiResponseElement.appendChild(disclaimerElement);
