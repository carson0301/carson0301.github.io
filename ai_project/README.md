...
訪問 `tech-implementation.html` 查看詳細的技術實現比較和模仿效果。
...
ai_project/
├── index.html              # 端選擇頁面
├── tech-implementation.html # 技術實現詳解頁面
├── test.html               # 開發測試頁面
├── pages/
│   ├── home.html          # 首頁
│   └── detect.html        # 檢測頁面
...
| 顏色 | 薄無裂紋 | 厚無裂紋 | 膩有裂紋 | 厚有裂紋 |
|------|----------|----------|----------|----------|
| **白苔** | 白苔薄無裂紋 | 白苔厚無裂紋 | 白苔膩有裂紋 | 白苔厚有裂紋 |
| **黃苔** | 黃苔薄無裂紋 | 黃苔厚無裂紋 | 黃苔膩有裂紋 | 黃苔厚有裂紋 |
| **淡紅苔** | 淡紅苔薄無裂紋 | 淡紅苔厚無裂紋 | 淡紅苔膩有裂紋 | 淡紅苔厚有裂紋 |
| **紫苔** | 紫苔薄無裂紋 | 紫苔厚無裂紋 | 紫苔膩有裂紋 | 紫苔厚有裂紋 |
...
- **`tech-implementation.html`** - 核心技術實現詳解，展示與澳門紙幣系統的技術比較
- **`test.html`** - 開發測試頁面，用於清除設備選擇記錄
